...
import './Lessquantity.css';

const Lessquantity = () => {
    const [managers, setManagers] = useState([]);
    useEffect(() => {
         fetch('https://localhost:44344/api/Product/lessquantity')
         .then(res => res.json())
              ...
              <table className="table user-list">
                 <thead>
                    <tr>
                       ...
                       <th className="text-center"><span>Available</span></th>
                 ...
                 <tbody>
                 {
                    ...
                    <tr key={manager.PId}>
                       <td>
                          <img src="https://emojipedia-us.s3.amazonaws.com/source/skype/289/delivery-truck_1f69a.png" alt="" />
                       ...
                       <td className="text-center">
                          <span className="label label-default">{manager.PStock}</span>
                       </td>
                       <td>
